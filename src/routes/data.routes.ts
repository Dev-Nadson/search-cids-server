...
import { list_occupations_procedures_controller } from "../controllers/list-occupations-procedures.controller.js";
...
async function data_routes(app: FastifyInstance) {
    ...
    app.get("/occupations-procedures", list_occupations_procedures_controller)
}
